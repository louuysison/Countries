...
public final class CountryService: NSObject {
    ...
    private func makeDataRequest() {
        // create urlString
        guard let urlString =
                "https://restcountries.com/v2/all?fields=name,alpha2Code,alpha3Code,topLevelDomain,callingCodes,capital,region,continent,population,borders,currencies,languages"
